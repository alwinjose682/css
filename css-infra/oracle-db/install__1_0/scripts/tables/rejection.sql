...
trade_version NUMBER(10) NOT NULL,
trade_leg_id NUMBER(19),
trade_leg_version NUMBER(10),
trade_type VARCHAR2(15) NOT NULL,
trade_leg_type VARCHAR2(15),
value_date DATE,
...
ALTER TABLE rejection ADD CONSTRAINT cfrej_pk PRIMARY KEY(id);
CREATE INDEX cfrej_replay_idx on rejection(value_date, curr_code, replayable);
