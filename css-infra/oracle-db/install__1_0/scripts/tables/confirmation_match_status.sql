...
sent_or_recd VARCHAR2(4) NOT NULL CONSTRAINT conf_strd_chk CHECK(sent_or_recd IN ('SENT','RECD')),    -- { sentOrRecd }
...
create INDEX conf_m_stat_idx2 on confirmation_match_status(conf_request_id);
