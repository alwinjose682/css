...
public class GeneratorController {
    ...
    public ResponseEntity<GeneratorHandlerOutcomeDto> start(@PathVariable String generatorKey,
        ...
        log.debug("Received Generator(Trade and ConfirmationMatchEvent) start request with params- generatorKey: {}, initialGeneratorValues: {}", generatorKey, initialGeneratorValues);
