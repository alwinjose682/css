...
public interface ConfirmationMatchEventMapper {
    ...
    ConfirmationMatchStatusAvro domainToAvro(ConfirmationMatchEvent confirmationMatchEvent);

    @InheritInverseConfiguration
    @Mapping(source = "tradeLegMatchAttributes", target = "tradeLegMatchAttributes")
    ConfirmationMatchEvent avroToDomain(ConfirmationMatchStatusAvro confirmationMatchStatusAvro);
}
