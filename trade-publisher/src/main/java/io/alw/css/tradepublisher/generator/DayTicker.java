...
public final class DayTicker extends Stoppable {
    ...
    static DayTicker initSingleton(long tickerIntervalSeconds, long intervalSecondsBeforeFirstTick, long graceSecondsToWaitForGeneratorsToStart, CssTaskExecutor cssTaskExecutor) {
        if (instance == null) {
