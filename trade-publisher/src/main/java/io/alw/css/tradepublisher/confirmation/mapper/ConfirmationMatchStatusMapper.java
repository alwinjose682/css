...
public interface ConfirmationMatchStatusMapper {
    ...
    ConfirmationMatchStatusAvro domainToAvro(ConfirmationMatchStatus confirmationMatchStatus);

    @InheritInverseConfiguration
    @Mapping(source = "tradeLegMatchAttributes", target = "tradeLegMatchAttributes")
    ConfirmationMatchStatus avroToDomain(ConfirmationMatchStatusAvro confirmationMatchStatusAvro);
}
