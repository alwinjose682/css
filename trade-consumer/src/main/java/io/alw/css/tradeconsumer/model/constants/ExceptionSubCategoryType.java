...
public interface ExceptionSubCategoryType {
    ...
    String INCORRECT_PREV_CF_REVISION_TYPE = "INCORRECT_PREV_CF_REVISION_TYPE";
    ...
    String CONF_REQ_PUB_FAILURE = "CONF_REQ_PUB_FAILURE";
    String NO_CONF_MATCH_ID = "NO_CONF_MATCH_ID";
    String CONF_REQ_ID_DIFFER_FOR_AMONG_PREV_CASHFLOWS = "CONF_REQ_ID_DIFFER_FOR_AMONG_PREV_CASHFLOWS";
    String PREV_CASHFLOW_NOT_EXIST_FOR_ALL = "PREV_CASHFLOW_NOT_EXIST_FOR_ALL";
    String EMPTY_CASHFLOW_LIST = "EMPTY_CASHFLOW_LIST";
    String CONF_STATUS_ENTRY_FAILURE = "CONF_STATUS_ENTRY_FAILURE";
    String CASHFLOW_CONF_FAILURE = "CASHFLOW_CONF_FAILURE";
}
