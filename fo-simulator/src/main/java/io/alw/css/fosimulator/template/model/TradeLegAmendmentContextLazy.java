...
public record TradeLegAmendmentContextLazy(
        ...
        TradeLeg tradeLeg,
        // Non-nullable fields
        Function<TradeLeg, Consumer<TradeLeg>> callbackProvider,
        Set<AmendableField> amendableFields) implements TradeLegAmendmentContext {

    public TradeLegAmendmentContextLazy(Function<TradeLeg, Consumer<TradeLeg>> callbackProvider, Set<AmendableField> amendableFields) {
